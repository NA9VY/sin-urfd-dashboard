...
$PageOptions['BrandmeisterTG']                       = '31188';                 // Brandmeister Talkgroup to create links
$PageOptions['PiDashboard']			     = 'dashboards.na9vy.us';	// Link to the grafana dashboard
$PageOptions['UptimePhrase']			     = 'Smoke has stayed in box for'; //Use 'Server Uptime' or whatever you want
