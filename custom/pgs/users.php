...
?> 
      ...
      <!-- ==================== GROK SUMMARY SECTION ==================== -->
      <div style="margin-top: 15px;">
         <h3 style="color:#00b0f0; margin-bottom:8px;">
            📡 URFSIN Latest Activity Summary
         </h3>
         ...
         if (file_exists($summaryFile)) {
             ...
             $lastUpdated = $timestamp ? date('M j, g:i A', strtotime($timestamp)) : 'Unknown';

             $linked = $data['linkedStations'] ?? '?';
             $unique = $data['uniqueCallsigns'] ?? '?';
             $heard = $data['heardEvents'] ?? '?';
         ?>
         
         <div style="background:#1a1a1a; padding:16px; border-radius:8px; border-left:5px solid #00b0f0;">
            <table style="width:100%; margin-bottom:12px; border-collapse:collapse;">
               <tr>
                  <td style="padding:8px; text-align:center; border-right:1px solid #333;">
                     <strong style="color:#0f0; font-size:1.2em;"><?php echo $linked; ?></strong><br>
                     <small>Linked Stations</small>
                  </td>
                  <td style="padding:8px; text-align:center; border-right:1px solid #333;">
                     <strong style="color:#0f0; font-size:1.2em;"><?php echo $unique; ?></strong><br>
                     <small>Unique Callsigns (24h)</small>
                  </td>
                  <td style="padding:8px; text-align:center;">
                     <strong style="color:#0f0; font-size:1.2em;"><?php echo $heard; ?></strong><br>
                     <small>Heard Events (24h)</small>
                  </td>
               </tr>
            </table>
         ...
         ?>
            <div style="background:#1a1a1a; padding:20px; border-radius:8px; color:#888;">
               Waiting for first Grok summary...
            </div>
         <?php } ?>
      </div>
   ...
   <div class="col-md-3">   <!-- Right sidebar continues -->
      <table class="table table-bordered table-striped table-hover">
         <?php 
